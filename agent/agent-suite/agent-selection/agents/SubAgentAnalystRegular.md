---
description: Handles bounded analysis and technical judgment. May edit documents, not code, tests, or configuration. Not for raw facts or baseline collection. Very low cost and fast.
type: subagent
model:
  id: analysis_regular
  thinking: medium
