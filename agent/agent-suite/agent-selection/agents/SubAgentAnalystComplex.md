---
description: Agent for complex Review, Analysis, Research, Investigation, Pattern Recognition, Algorithm extraction/identification and documentation, Specification/PRD design, Architecture design, Planning, Business Logic extraction/analysis, and similar intelligence NON-CODING tasks (including creation or modification of files with corresponding documents). MUST NOT use for simple search or information retrieval tasks, use SubAgentExtractor for that. NO CODING, BUG FIXING, OR ANY CODE MODIFICATION tasks. Moderate cost and speed.
type: subagent
model:
  id: analysis_complex
  thinking: medium
